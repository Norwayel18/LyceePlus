...
<div class="row-6 d-flex">
    ...
    <div class="form-group "> 
        <div id="moduleContainer" style="display: none;">
            ...
            <select name="module_id" id="moduleSelect" class="form-select">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('exam-notes.calculate') }}" method="POST">
                        @csrf
                   <input type="hidden" name="module_id" id="module_id" value="">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary" id='close-modal' data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary" id="saveNoteButton">Save</button>
                        </div>
                    </form>
            </div>
        </div>
...
<script>
    ...
    document.getElementById('classSelect').addEventListener('change', function() {
        ...
        // Reset module buttons container
    ...
    moduleButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            // Set the module_id value in the hidden input field
            ...
            saveNoteButton.addEventListener('click', function() {
                ...
                // You can perform further actions with the exam values and module_id
                console.log('Module ID:', moduleId);
                console.log('Exam 1:', exam1);
                console.log('Exam 2:', exam2);
                console.log('Exam 3:', exam3);
